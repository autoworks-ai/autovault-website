...
export const releases: Release[] = [
  {
    ...
    sections: [
      { kind: "added", items: ["Bundled skills: autovault-skill, commit-message, and skill-author", "scripts/bootstrap-skills.mjs seeds bundled skills through the real install_skill validation path", "autovault add-local installs local skill bundles from third-party installers with local provenance", "autovault remove deletes vaulted skills and prunes AutoVault-managed profile symlinks with default native profile discovery", "AUTOVAULT_SKILL_INSTALL controls AutoVault-first, native-first, both, native-only, and off routing", "Remote Streamable HTTP MCP at /mcp with OAuth discovery, login, token issuance, and role-aware skill visibility"] },
