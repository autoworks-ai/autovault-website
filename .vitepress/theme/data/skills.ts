...
export const skills: Skill[] = [
  {
    ...
    license: "MIT",
    size: "3,078 B",
    install: "add_skill({ source: \"github\", identifier: \"https://github.com/autoworks-ai/autovault-website/blob/main/public/skills/autovault-bootstrap/SKILL.md\" })",
  ...
  },
  {
    ...
    license: "MIT",
    size: "9,406 B",
    install: "add_skill({ source: \"github\", identifier: \"https://github.com/autoworks-ai/autovault/blob/main/skills/skill-author/SKILL.md\" })",
  ...
  },
  {
    ...
    license: "MIT",
    size: "6,709 B",
    install: "add_skill({ source: \"github\", identifier: \"https://github.com/autoworks-ai/autovault/blob/main/skills/autovault-skill/SKILL.md\" })",
  ...
  },
  {
    ...
    license: "MIT",
    size: "1,508 B",
    install: "add_skill({ source: \"github\", identifier: \"https://github.com/autoworks-ai/autovault-website/blob/main/public/skills/multi-agent-transform/SKILL.md\" })",
  ...
  },
  {
    ...
    license: "MIT",
    size: "2,157 B",
    install: "add_skill({ source: \"github\", identifier: \"https://github.com/autoworks-ai/autovault-website/blob/main/public/skills/secret-safe-setup/SKILL.md\" })",
