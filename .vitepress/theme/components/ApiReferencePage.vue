  ...
  <div class="api-shell reveal-page">
    ...
    <main class="api-main">
      <section class="api-hero reveal-item">
        ...
        <p class="lede">Current v0.4.0 surfaces are the local CLI, source ESM library exports, local stdio MCP, and remote Streamable HTTP MCP at <code>/mcp</code>. There is no public REST API or separately published SDK package yet; MCP tools are the agent-facing API.</p>
...
const nav: NavItem[] = [
  ...
  { kind: "item", id: "cli-import-autohub", method: "cli", label: "import-autohub" },
...
const sections: ApiSection[] = [
  {
    ...
    items: [
      ...
      endpoint("cli-import-autohub", "import-autohub", "autovault import-autohub", "Ingest a curated AutoHub bundle into the vault. Applies tool filters and an optional MCP-server descriptor. <code>--reset</code> clears prior import state before importing.", "$ autovault import-autohub --tool-filters /path/tool-filters.json [--mcp-servers /path/mcp-servers.json] [--reset]", "autovault import-autohub --tool-filters ./autohub/tool-filters.json", "0.2.0"),
