...
const explanations = {
  ...
  tools: { lines: "L7-L9", label: "tools_required", short: "canonical capabilities", required: false, title: "Canonical tool requirements", body: "<p>The skill declares the capabilities it expects using AutoVault's stable names, not one agent's temporary tool vocabulary.</p><p>The capability/behavior check compares these declarations with the body and transform maps.</p>" },
...
const schemaRows: SchemaRow[] = [
  ...
  { field: "tools_required", type: "string[]", required: false, description: "Canonical capability names the skill body expects to use." },
